...
const MANUAL_DATA = [
  {
    ...
    steps: [
      { step: 1, title: "顧客データの検索", content: "対象のメールアドレスでKraken内を検索し、既存アカウントを特定します。", aiImgDesc: "Krakenの画面で検索窓にメールアドレスを入力している。ダークモードのUI。" },
      { step: 2, title: "アカウント統合ボタンの押下", content: "「紐付け（マージ）」ボタンをクリックしてアカウントを統合します。", aiImgDesc: "マージボタンが強調されたKrakenの顧客詳細画面。" },
      { step: 3, title: "統合完了の確認", content: "統合が正常に完了したことを確認し、顧客に案内します。", aiImgDesc: "統合完了メッセージが表示された顧客アカウント画面。" },
    ]
  },
  {
    id: "inv-bh",
    ...
    steps: [
      { step: 1, title: "アカウントの無効化", content: "管理画面から「アカウントを無効化する」オプションを選択します。", aiImgDesc: "アカウント設定画面で「無効化」ボタンが強調されている。" },
      { step: 2, title: "BH送りの設定", content: "システム上でBHフラグを立て、これ以上の通知がいかないように設定します。", aiImgDesc: "BHフラグのチェックボックスが表示された画面。" }
    ]
  },
  {
    id: "plan-cancel",
    ...
    steps: [
      { step: 1, title: "プランの確認", content: "Customer ページから現在の適用プランを確認します。", aiImgDesc: "プラン詳細が表示されたCustomer画面。" },
      { step: 2, title: "プラン変更の実行", content: "アクションメニューから「Change Plan」を選択し、新しいプランを選びます。", aiImgDesc: "プラン変更プルダウンが表示された画面。" },
      { step: 3, title: "キャンセルの実行", content: "申し込みキャンセルの場合は、「Cancel Account」をクリックして処理します。", aiImgDesc: "キャンセル確認画面。" },
    ]
  },
  {
    id: "move-out",
    ...
    steps: [
      { step: 1, title: "退去日の入力", content: "お客様から申告された退去日をシステムに入力します。", aiImgDesc: "退去日入力フィールドがある画面。" },
      { step: 2, title: "最終検針の確認", content: "※現在フロー整備中につき、管理者に確認してください。", aiImgDesc: "検針ステータスが「未確認」となっている画面。" }
    ]
  },
  {
    id: "re-ignition",
    ...
    steps: [
      { step: 1, title: "停止理由の確認", content: "直近の供給停止理由（未払い等）をヒストリーから確認します。", aiImgDesc: "アカウントヒストリー画面。" },
      { step: 2, title: "再点処理の実行", content: "問題が解消されている場合、再点火のプロシージャを実行します。", aiImgDesc: "再点火実行ボタンがある画面。" }
    ]
  },
  {
    id: "inv-address",
    ...
    steps: [
      { step: 1, title: "エラーログの確認", content: "バウンスログから「無効なアドレス」であることを確認します。", aiImgDesc: "エラーログ詳細画面。" },
      { step: 2, title: "お客様への連絡と修正", content: "お客様に確認し、正しいアドレスに修正してシステムを上書きします。", aiImgDesc: "アドレス修正画面。" }
    ]
  },
  {
    id: "addr-spin",
    ...
    steps: [
      { step: 1, title: "新住所の特定", content: "新しい住所を検索し、正確な表記を確認します。", aiImgDesc: "住所検索ツール。" },
      { step: 2, title: "SPIN番号の紐付け", content: "取得した22桁のSPIN番号を入力フォームに貼り付けます。", aiImgDesc: "SPIN入力フィールド。" }
    ]
  }
];
...
export default function ProcedureWizard() {
  ...
  const [expandedSteps, setExpandedSteps] = useState<number[]>([1]); // 最初はSTEP1だけ開いておく
  ...
  return (
    <div className="global-theme-wrapper theme-dark">
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .accordion-item.open .accordion-body { max-height: 1000px; } /* 画像が入るので高めに設定 */
        ...
        /* スクショ画像用プレースホルダー（AI生成画像の説明を表示！） */
        .image-placeholder { width: 100%; border: 2px dashed rgba(255,255,255,0.1); border-radius: 16px; background: rgba(0,0,0,0.2); display: flex; flex-direction: column; align-items: center; justify-content: center; color: #64748b; font-weight: 800; font-size: 12px; overflow: hidden; position: relative; padding: 30px; text-align: center; gap: 10px;}
